...
const InterviewCalendarView = ({ interviews, selectedDate, timeRange, onDateChange }) => {
  ...
  const getStatusColor = (interview) => {
    ...
    if (isUnattended) return 'bg-red-100 dark:bg-red-900/30 border-red-300 dark:border-red-700 text-red-800 dark:text-red-200'
    
    switch (interview.status) {
      case 'scheduled':
        return 'bg-blue-100 dark:bg-blue-900/30 border-blue-300 dark:border-blue-700 text-blue-800 dark:text-blue-200'
      case 'completed':
        if (interview.result === 'pass') return 'bg-green-100 dark:bg-green-900/30 border-green-300 dark:border-green-700 text-green-800 dark:text-green-200'
        if (interview.result === 'fail') return 'bg-red-100 dark:bg-red-900/30 border-red-300 dark:border-red-700 text-red-800 dark:text-red-200'
    ...
    <div className="space-y-6">
          ...
          return (
            <div
              ...
              className={`border rounded-lg p-4 min-h-[200px] ${
                isToday ? 'border-blue-500 bg-blue-50 dark:bg-blue-900/20 dark:border-blue-400' : 'border-gray-200 dark:border-gray-600 bg-white dark:bg-gray-800'
              }`}
            >
              {/* Day Header */}
              <div className="flex items-center justify-between mb-3">
                <div>
                  ...
                  <div className={`text-lg font-bold ${isToday ? 'text-blue-700 dark:text-blue-300' : 'text-gray-900 dark:text-gray-100'}`}>
                    {format(date, 'dd')}
                  </div>
                </div>
      ...
      {showDetails && selectedInterview && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
          <div className="bg-white dark:bg-gray-800 rounded-lg w-full max-w-2xl max-h-screen overflow-y-auto">
            <div className="flex items-center justify-between p-6 border-b border-gray-200 dark:border-gray-600">
              <h2 className="text-xl font-semibold text-gray-900 dark:text-gray-100">Interview Details</h2>
              <button
                onClick={() => {
            ...
            <div className="p-6 space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  <h3 className="text-lg font-medium text-gray-900 dark:text-gray-100 mb-3">Candidate</h3>
                  <div className="space-y-2">
                    <div className="flex items-center space-x-2">
              ...
              {/* Interviewer */}
              <div>
                <h3 className="text-lg font-medium text-gray-900 dark:text-gray-100 mb-3">Interviewer</h3>
              ...
              {selectedInterview.notes && (
                <div>
                  ...
                  <div className="bg-gray-50 dark:bg-gray-700 rounded-lg p-4">
                    <p className="text-gray-700 dark:text-gray-300 whitespace-pre-wrap">{selectedInterview.notes}</p>
                  </div>
                </div>
              )}
              ...
              {selectedInterview.rejection_reason && (
                <div>
                  <h3 className="text-lg font-medium text-gray-900 dark:text-gray-100 mb-3">Rejection Reason</h3>
                  <div className="bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800 rounded-lg p-4">
                    <p className="text-red-800 dark:text-red-200">{selectedInterview.rejection_reason}</p>
                  </div>
                </div>
              )}
      ...
      <div className="card p-4">
        <h3 className="text-sm font-medium text-gray-900 dark:text-gray-100 mb-3">Status Legend</h3>
