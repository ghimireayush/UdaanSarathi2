...
const StatsSection = ({ t }) => {
  ...
  return (
    <section className="py-16 md:py-24 bg-gradient-to-b from-blue-50/40 via-white to-blue-50/40 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
          {statItems.map((stat, index) => (
            <div
              key={index}
              className="group relative bg-white/95 backdrop-blur-sm dark:bg-gray-800/95 rounded-2xl p-8 shadow-lg hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2 border border-blue-100/50 dark:border-gray-700"
            >
